...
inventory = st.data_editor(
    DEFAULT_INVENTORY, num_rows="dynamic", width='stretch',
    column_config={
...
with run_col:
    run_clicked = st.button("🚀 Run Multi-Agent Analysis", type="primary", width='stretch')
...
if run_clicked:
    ...
    with tab3:
        ...
        st.dataframe(waste_df, width='stretch')
    ...
    with tab4:
        ...
        st.dataframe(discount_df, width='stretch')
    ...
    with tab5:
        ...
        st.altair_chart(waterfall + zero_line, width='stretch')
